...
export const assessMacRelease = (
  ...
  return {
    ...
    operatorChecklist: [
      ...
      `${manifest.version ?? "현재 내부 베타"}는 Toss·Upbit·Bithumb 실제 주문과 취소를 HTTP 423으로 차단하며 자동화는 paper 전용입니다.`,
    ],
    files,
  };
};
...
const defaultReleaseSetChecklist = [
  ...
  "현재 내부 베타는 Toss·Upbit·Bithumb 실제 주문과 취소를 HTTP 423으로 차단하며 자동화는 paper 전용입니다.",
];
