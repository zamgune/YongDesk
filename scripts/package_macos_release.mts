...
12. 이 앱을 다시 사용할 계획이 없다면 앱에서 credential을 삭제하고 발급처에서도 API 키를 폐기합니다. 계속 사용할 예정이면 삭제할 필요가 없습니다. 로그·스크린샷에는 키, 토큰, 계좌번호를 포함하지 않습니다.
...
10. 이 앱을 다시 사용할 계획이 없다면 앱에서 credential을 삭제하고 발급처에서도 API 키를 폐기합니다. 계속 사용할 예정이면 삭제할 필요가 없습니다.
